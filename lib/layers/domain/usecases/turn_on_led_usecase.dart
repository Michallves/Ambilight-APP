...
abstract class TurnOnLedUsecase {
  Future<void> call(DeviceEntity deviceEntity);
}

class TurnOnLedUsecaseImpl implements TurnOnLedUsecase {
  static final List<int> commandOn = [
    0x00,
    0x04,
    0x80,
    0x00,
  ...
  Future<void> call(DeviceEntity deviceEntity) async {
    try {
      ...
      await writeCharacteristic.write(commandOn, withoutResponse: true);
    } catch (e) {
